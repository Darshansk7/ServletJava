...
<head>
    ...
    <title>Welcome - Registration System</title>
...
<body class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
    <div class="w-full max-w-md p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg text-center">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Welcome, <%= session.getAttribute("username") %>!</h2>
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-6">You are now logged in.</p>
        <form action="LogoutServlet" method="post">
            <button type="submit" class="btn-hover w-full px-4 py-2 bg-red-600 text-white rounded-md hover:bg-blue-700 transition-colors">Logout</button>
        </form>
    </div>
    <script>
